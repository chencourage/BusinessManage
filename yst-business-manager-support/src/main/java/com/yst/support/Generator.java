...
public class Generator {
	...
	public static void main(String[] args) {
		...
		strategy.setInclude(new String[] {"add_agent_white_list"}); // 需要生成的表
//		strategy.setTablePrefix(new String[] { "sys_" });// 此处可以修改为您的表前缀
//		 strategy.setExclude(new String[]{"sys_role_menu","sys_role_user"}); // 排除生成的表
		// 自定义实体父类
		strategy.setSuperEntityClass("com.yst.core.base.BaseEntity");
		// 自定义实体，公共字段
...
//		strategy.setSuperMapperClass("org.ibase4j.core.base.BaseMapper");
		// 自定义 service 父类
		strategy.setSuperServiceClass("com.yst.core.base.IBaseService");
		// 自定义 service 实现类父类
		strategy.setSuperServiceImplClass("com.yst.core.base.BaseService");
		// 自定义 controller 父类
//		strategy.setSuperControllerClass("org.ibase4j.core.base.AbstractController");
		...
		pc.setParent("com.yst.core.manager");
		pc.setEntity("entity");
		pc.setMapper("mapper");
