 ...
 * @since 2019-06-24
 */
@TableName("REPORT_AGENT_DAY_RECRUIT")
public class ReportAgentDayRecruit extends BaseEntity {
     ...
     * 当日开通商户数
     */
	@TableField("RECRUIT_DAY_CNT")
	private String recruitDayCnt;
    /**
     * 扩展日
     */
	@TableField("RECRUIT_DAY")
     ...
     * 当日开通大pos商户数
     */
	@TableField("RECRUIT_DAY_CNT_BIGPOS")
	private String recruitDayCntBigpos;
    /**
     * 当日开通mpos商户数
     */
	@TableField("RECRUIT_DAY_CNT_MPOS")
	private String recruitDayCntMpos;
	@TableField("TESTS")
     ...
     * 当日开通vip商户数
     */
	@TableField("RECRUIT_DAY_CNT_VIP")
	private String recruitDayCntVip;
    /**
     * 当月开通vip商户数
     */
	...
	public String getRecruitDayCnt() {
		return recruitDayCnt;
	}

	public void setRecruitDayCnt(String recruitDayCnt) {
		this.recruitDayCnt = recruitDayCnt;
	}
	...
	public void setRecruitDay(String recruitDay) {
	...
	public String getRecruitDayCntBigpos() {
		return recruitDayCntBigpos;
	}

	public void setRecruitDayCntBigpos(String recruitDayCntBigpos) {
		this.recruitDayCntBigpos = recruitDayCntBigpos;
	}

	public String getRecruitDayCntMpos() {
		return recruitDayCntMpos;
	}

	public void setRecruitDayCntMpos(String recruitDayCntMpos) {
		this.recruitDayCntMpos = recruitDayCntMpos;
	}
	...
	public String getRecruitDayCntVip() {
		return recruitDayCntVip;
	}

	public void setRecruitDayCntVip(String recruitDayCntVip) {
		this.recruitDayCntVip = recruitDayCntVip;
	}
	...
	public String toString() {
		return "ReportAgentDayRecruit{" +
			...
			", recruitDayCntBigpos=" + recruitDayCntBigpos +
			", recruitDayCntMpos=" + recruitDayCntMpos +
			", tests=" + tests +
			", recruitYearCntVip=" + recruitYearCntVip +
			", recruitDayCntVip=" + recruitDayCntVip +
